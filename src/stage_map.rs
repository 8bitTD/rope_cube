...
pub fn get_stage4() -> Stage{
    Stage::new(0.0, 130.0)
        .add_block(-150.0, 820.0, 1000.0, 10.0, 0.0)
        .add_block(-150.0, -820.0, 1000.0, 10.0, 0.0)
        .add_block(-1140.0, 0.0, 10.0, 820.0, 0.0)
        .add_block(840.0, 0.0, 10.0, 820.0, 0.0)
        .add_block(-40.0, -345.0, 170.0, 10.0, 0.0)
        .add_block(-160.0, 50.0, 300.0, 10.0, 0.0)
        .add_block(-470.0, -380.0, 10.0, 440.0, 0.0)
        .add_block(140.0, 0.0, 10.0, 625.0, 0.0)
        .add_block(-380.0, 651.0, 10.0, 170.0, 0.0)
        .add_block(-390.0, 300.0, 530.0, 10.0, 0.0)
        .add_block(-910.0, 17.0, 10.0, 573.0, 0.0)
}
