...
pub fn get_stage3() -> Stage{
    Stage::new(30.0, -920.0)//ゴール
        .add_block(-170.0, 300.0, 400.0, 10.0)//上
        .add_block(-560.0, -130.0, 10.0, 440.0)//左
        .add_block(220.0, -130.0, 10.0, 440.0)//右
        .add_block(-20.0, -170.0, 240.0, 10.0)//中下
        .add_block(-290.0, -570.0, 280.0, 10.0)//左下
        .add_block(150.0, -570.0, 80.0, 10.0)//右下
        .add_block(-260.0, -80.0, 10.0, 200.0)//縦障害物上
        .add_block(-160.0, -450.0, 10.0, 120.0)//縦障害物下
        .add_block(00.0, -760.0, 10.0, 200.0)//ゴール左
        .add_block(60.0, -760.0, 10.0, 200.0)//ゴール右
        .add_block(30.0, -950.0, 30.0, 10.0)//ゴール下
}
