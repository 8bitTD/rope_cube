...
pub fn get_stage5() -> Stage{
    Stage::new(0.0, -200.0)//ゴール
        ...
        .add_block(-1000.0, -900.0, 10.0, 1000.0, 0.0)//左
        .add_block(1000.0, -900.0, 10.0, 1000.0, 0.0)//右
        
        .add_block(-350.0, -180.0, 10.0, 350.0, 95.0)//左ギミック
        .add_block(-660.0, -400.0, 10.0, 350.0, 75.0)
        .add_block(-200.0, -550.0, 10.0, 350.0, 5.0)
        .add_block(-500.0, -750.0, 10.0, 350.0, 65.0)
        .add_block(-750.0, -900.0, 10.0, 200.0, 90.0)
        .add_block(-520.0, -1100.0, 10.0, 400.0, 120.0)
        .add_block(-560.0, -1520.0, 10.0, 450.0, 140.0)
        .add_block(-130.0, -1320.0, 10.0, 430.0, 185.0)

        .add_block(400.0, -200.0, 10.0, 400.0, 80.0)//右ギミック
        .add_block(660.0, -500.0, 10.0, 350.0, 75.0)
        .add_block(200.0, -1000.0, 10.0, 800.0, 0.0)
